...
void qSlicerAppMainWindowPrivate::setupUi(QMainWindow* mainWindow)
{
  ...
  const QString appDisplayName = qSlicerApplication::application()->mainApplicationDisplayName();
  ...
  helpVisitSlicerForumAction->setText(qSlicerAppMainWindow::tr("Visit the %1 Forum").arg(appDisplayName));
  ...
  helpSlicerPublicationsAction->setText(qSlicerAppMainWindow::tr("%1 Publications").arg(appDisplayName));
  ...
  helpAcknowledgmentsAction->setText(qSlicerAppMainWindow::tr("%1 Acknowledgments").arg(appDisplayName));
  ...
  helpReportBugOrFeatureRequestAction->setToolTip(qSlicerAppMainWindow::tr("Report an issue or request an enhancement."));
  ...
  helpAboutSlicerAppAction->setToolTip(qSlicerAppMainWindow::tr("Learn more about the project vision and contributors."));
